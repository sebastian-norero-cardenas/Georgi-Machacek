...
sc = ax.scatter(
        ...
        y=df['ctau_minimum [cm]'],  # second variable scattered over the y-axis
...
ax.text(x=mh*(1 - 0.12), y=1e-05, s=r'$m_5 = m_h$', color="black", fontsize=7, rotation=90)
...
# SAVE PLOT
plt.savefig('CTAU_MINIMUM_m5_WP_GMSEESAW_LOGSCAN.png',
        bbox_inches='tight',
        dpi=300)
