...
sc = ax.scatter(
        ...
        c=(np.abs(df['m5 [GeV]']-df['m3 [GeV]'])/df['m3 [GeV]']) * 100,  # third variable represented as a color gradient
...
ax.set_ylim(bottom=1e-08, top=1e11)
...
# SAVE PLOT
plt.savefig('M5_CTAUH5pp_M3M5_GMSEESAW.png',
            bbox_inches='tight',
            dpi=100)
