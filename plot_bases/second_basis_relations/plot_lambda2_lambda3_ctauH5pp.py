...
# SCATTERING PLOT
sc = ax.scatter(
        x=df['lam2'],  # first variable scattered over the x-axis
        y=df['lam3'],  # second variable scattered over the y-axis
...
# SAVE PLOT
plt.savefig('lambda2_lambda3_ctauH5pp_GMSEESAW.png',
            bbox_inches='tight',
            dpi=100)
