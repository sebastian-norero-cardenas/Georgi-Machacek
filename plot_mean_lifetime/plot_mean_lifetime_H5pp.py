...
# import matplotlib.colors as cls  # for a color bar in logarithmic scale
...
sc = ax.scatter(
        ...
        y=df['tau_H5pp [s]'],  # second variable scattered over the y-axis
...
ax.text(x=7.982436e+01*(1 - 0.30), y=1e-10, s=r'$m_5 = m_W$', color="black", fontsize=7, rotation=90)

# m5=2mW line
plt.axvline(x=2*7.982436e+01, color="black", linestyle="--", linewidth=0.5)
ax.text(x=2*7.982436e+01*(1 - 0.15), y=1e-10, s=r'$m_5 = 2m_W$', color="black", fontsize=7, rotation=90)
...
# SAVE PLOT
plt.savefig('tau_H5pp_GMSEESAW.png',
        bbox_inches='tight',
        dpi=300)
