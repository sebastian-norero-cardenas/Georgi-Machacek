...
ax.text(x=mW*(1 - 0.30), y=1e+00, s=r'$m_5 = m_W$', color="black", fontsize=7, rotation=90)
...
# m5=mW+mZ line
plt.axvline(x=mW+mZ, color="black", linestyle="--", linewidth=0.5)
ax.text(x=(mW+mZ)*(1 - 0.11), y=1e+03, s=r'$m_5 = m_W + m_Z$', color="black", fontsize=7, rotation=90)
...
# SAVE PLOT
plt.savefig('m5_ctauH5p_MDCH_GMSEESAW.png',
        bbox_inches='tight',
        dpi=100)
