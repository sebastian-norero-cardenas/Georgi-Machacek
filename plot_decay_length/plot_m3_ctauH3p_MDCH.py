...
ax.text(x=mh*(1 - 0.15), y=7e-15, s=r'$m_3 = m_h$', color="black", fontsize=7, rotation=90)

# m3=mh+mW line
# plt.axvline(x=mh+mW, color="black", linestyle="--", linewidth=0.5)
# ax.text(x=(mh+mW)*(1 - 0.15), y=7e-15, s=r'$m_3 = m_h + mW$', color="black", fontsize=7, rotation=90)
...
# SAVE PLOT
plt.savefig('m3_ctauH3p_MDCH_GMSEESAW.png',
        bbox_inches='tight',
        dpi=100)
