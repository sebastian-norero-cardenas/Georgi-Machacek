...
ax.text(x=2*7.982436e+01*(1 - 0.12), y=1e+03, s=r'$m_5 = 2m_W$', color="black", fontsize=7, rotation=90)

# m5=2mZ line
plt.axvline(x=2*91.1876, color="black", linestyle="--", linewidth=0.5)
ax.text(x=2*9.11876e+01*(1 - 0.1), y=1e+02, s=r'$m_5 = 2m_Z$', color="black", fontsize=7, rotation=90)
...
ax.legend(handles=handles_list, loc='upper right', ncol=4, fontsize='small')
...
# SAVE PLOT
plt.savefig('m5_ctauH5z_MDCH_GMSEESAW.png',
        bbox_inches='tight',
        dpi=100)
