...
ax.text(x=1.2518e+02*(1 - 0.15), y=1e-15, s=r'$m_3 = m_h$', color="black", fontsize=7, rotation=90)

# m3=mh+mZ line
plt.axvline(x=1.2518e+02 + 91.1876, color="black", linestyle="--", linewidth=0.5)
ax.text(x=(1.2518e+02 + 91.1876)*(1 - 0.15), y=3e-16, s=r'$m_3 = m_h + m_Z$', color="black", fontsize=7, rotation=90)
...
# SAVE PLOT
plt.savefig('m3_ctauH3z_vDelta_GMSEESAW.png',
        bbox_inches='tight',
        dpi=100)
